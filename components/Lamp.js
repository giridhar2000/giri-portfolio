...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-slate-900 w-full backdrop-brightness-200 rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 xl:translate-y-12 2xl:-translate-y-12 items-center justify-center isolate z-0">
        <motion.div
      ...
      <div className="relative z-50 flex 2xl:-translate-y-80 xl:-translate-y-48 -translate-y-80 flex-col items-center px-5">
        {children}
      </div>
    </div>
  );
